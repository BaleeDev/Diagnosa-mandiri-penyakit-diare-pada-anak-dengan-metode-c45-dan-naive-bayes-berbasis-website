    ...
    <div class="container">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Semua Data Penyakit Diare Pada Anak</h6>
            ...
            <div class="card-body">
                ...
                if (@$_SESSION['Admin']) {
                ?>
                    <a href="tambah_data.php" class="btn btn-outline-primary text-right">Tambah Data</a>
                <?php
                }
                ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                        <tr>
                                            ...
                                            ?>
                                                <td>
                                                    <a href="edit_data.php?id=<?= $row['id'] ?>" class="badge badge-warning">Edit</a>
                                                    <a href="hapus_data.php?id=<?= $row['id'] ?>" id="hapus" class="badge badge-danger">Hapus</a>
                                                </td>
                                            <?php
                                            }
                                            ?>
